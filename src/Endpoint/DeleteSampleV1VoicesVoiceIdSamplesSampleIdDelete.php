...
class DeleteSampleV1VoicesVoiceIdSamplesSampleIdDelete extends \ElevenLabs\V1\SDK\Runtime\Client\BaseEndpoint implements \ElevenLabs\V1\SDK\Runtime\Client\Endpoint
{
    protected $voice_id;
    protected $sample_id;
    /**
     ...
     * }
     */
    public function __construct(string $voiceId, string $sampleId, array $headerParameters = array())
    {
    ...
    {
        return str_replace(array('{voice_id}', '{sample_id}'), array($this->voice_id, $this->sample_id), '/v1/voices/{voice_id}/samples/{sample_id}');
    }
    ...
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (422 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \ElevenLabs\V1\SDK\Exception\DeleteSampleV1VoicesVoiceIdSamplesSampleIdDeleteUnprocessableEntityException($serializer->deserialize($body, 'ElevenLabs\\V1\\SDK\\Model\\HTTPValidationError', 'json'), $response);
        }
    }
