...
class V1VoicesVoiceIdSettingsEditPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'ElevenLabs\\V1\\SDK\\Model\\V1VoicesVoiceIdSettingsEditPostBody';
    }
    public function supportsNormalization($data, $format = null) : bool
    {
        return is_object($data) && get_class($data) === 'ElevenLabs\\V1\\SDK\\Model\\V1VoicesVoiceIdSettingsEditPostBody';
    }
    /**
     * @return mixed
     */
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \ElevenLabs\V1\SDK\Model\V1VoicesVoiceIdSettingsEditPostBody();
